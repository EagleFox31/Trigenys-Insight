...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_kind" AS ENUM('analysis', 'guide', 'comparison', 'field-note');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_kind" AS ENUM('analysis', 'guide', 'comparison', 'field-note');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('fr', 'en');
  CREATE TYPE "public"."enum_reports_access_level" AS ENUM('free', 'premium');
  CREATE TYPE "public"."enum_reports_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__reports_v_version_access_level" AS ENUM('free', 'premium');
  CREATE TYPE "public"."enum__reports_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__reports_v_published_locale" AS ENUM('fr', 'en');
  CREATE TYPE "public"."enum_research_sources_language" AS ENUM('fr', 'en', 'other');
  ...
  CREATE TABLE "posts" (
  	...
  	"published_at" timestamp(3) with time zone,
  	"kind" "enum_posts_kind" DEFAULT 'analysis',
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_published_at" timestamp(3) with time zone,
  	"version_kind" "enum__posts_v_version_kind" DEFAULT 'analysis',
  	"version_reading_time" numeric,
  	"version_featured" boolean DEFAULT false,
  	"version_editors_pick" boolean DEFAULT false,
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "reports" (
  	...
  	"access_level" "enum_reports_access_level" DEFAULT 'free',
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_reports_v" (
  	...
  	"version_access_level" "enum__reports_v_version_access_level" DEFAULT 'free',
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "research_sources" (
  	...
  	"language" "enum_research_sources_language" DEFAULT 'fr',
  	"notes" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "newsletter_subscribers" (
  	...
  	"locale" "enum_newsletter_subscribers_locale" DEFAULT 'fr' NOT NULL,
  ...
  ALTER TABLE "posts_rels" ADD CONSTRAINT "posts_rels_research_sources_fk" FOREIGN KEY ("research_sources_id") REFERENCES "public"."research_sources"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_rels" ADD CONSTRAINT "_posts_v_rels_research_sources_fk" FOREIGN KEY ("research_sources_id") REFERENCES "public"."research_sources"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "reports_rels" ADD CONSTRAINT "reports_rels_research_sources_fk" FOREIGN KEY ("research_sources_id") REFERENCES "public"."research_sources"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_reports_v_rels" ADD CONSTRAINT "_reports_v_rels_research_sources_fk" FOREIGN KEY ("research_sources_id") REFERENCES "public"."research_sources"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "posts_rels_research_sources_id_idx" ON "posts_rels" USING btree ("research_sources_id");
  ...
  CREATE INDEX "_posts_v_rels_research_sources_id_idx" ON "_posts_v_rels" USING btree ("research_sources_id");
  ...
  CREATE INDEX "reports_rels_research_sources_id_idx" ON "reports_rels" USING btree ("research_sources_id");
  ...
  CREATE INDEX "_reports_v_rels_research_sources_id_idx" ON "_reports_v_rels" USING btree ("research_sources_id");
...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_reports_access_level";
  DROP TYPE "public"."enum_reports_status";
  DROP TYPE "public"."enum__reports_v_version_access_level";
  DROP TYPE "public"."enum__reports_v_version_status";
  DROP TYPE "public"."enum__reports_v_published_locale";
  DROP TYPE "public"."enum_research_sources_language";
